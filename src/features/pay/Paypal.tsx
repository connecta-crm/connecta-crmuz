...
import paypal from '../../../public/img/qr-code/paypal-ocean.svg';
import paypalmate from '../../../public/img/qr-code/paypal-mate.svg';
          ...
          <div className="pay__form__body">
            ...
            <div className="text-center mt-20 mb-20">
              <img
                width="200px"
                height="200px"
                src={companyName == 'OCEAN' ? paypal : paypalmate}
                alt=""
              />
            </div>
              ...
              <div
                ...
                onClick={() => {
                  navigator.clipboard.writeText(
                    `${companyName == 'OCEAN' ? '@oceanbluego' : '@MateLogistics'}`,
                  );
