...
function FeatPayPaidToCarrierInner({ feature, keyValue }: FeatItemInnerProps) {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    switch (feature) {
      case 'order':
        dispatch(updateOrderField({ field: 'paymentPaidToCarrier', value }));
        break;
      default:
        break;
    }
  ...
  return (
    <div className="d-flex justify-end feature-content">
      ...
      >
        <Input
          value={featureData.paymentPaidToCarrier}
          defaultValue={featureData.paymentPaidToCarrier}
...
export default FeatPayPaidToCarrierInner;
