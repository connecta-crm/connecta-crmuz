...
function FeatPayPaidToCarrierInner({ feature, keyValue }: FeatItemInnerProps) {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    switch (feature) {
      case 'order':
        dispatch(
          updateOrderField({ field: 'payments.paymentPaidToCarrier', value }),
        );
        break;
      default:
        break;
  ...
  return (
    <div className="d-flex justify-end feature-content">
      ...
      >
        <Input
          value={featureData.payments?.paymentPaidToCarrier}
          defaultValue={featureData.payments?.paymentPaidToCarrier}
