...
function FeatPersonEmailInner({ feature }: FeatItemInnerProps) {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    switch (feature) {
      case 'lead':
        dispatch(updateLeadField({ field: 'customer.email', value }));
        break;
      case 'quote':
        dispatch(updateQuoteField({ field: 'customer.email', value }));
        break;
      case 'order':
        dispatch(updateOrderField({ field: 'customer.email', value }));
        break;
      default:
        break;
    }
  ...
  return (
    <div className="d-flex justify-between mb-5">
      ...
      <Input
        value={featureData.customer.email}
