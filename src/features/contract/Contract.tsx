                ...
                <div className="pdf__container">
                  ...
                  <div className="pdp__content">
                    ...
                    <div className="pdf__text">
                      This agreement is executed on {contract?.executedOn}{' '}
                      between following parties:
                    </div>
                    ...
                    <h3 className="pdf__middle__title mt-40">
                      ...
                      above as demonstrated by their signature:
                    </h3>
                  ...
                  <div className="pdf__footer">
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          '/contract/' + params.text + `/${params.id}/terms`,
                        )
                      }
                    >
                      Next
